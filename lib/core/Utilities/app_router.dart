  ...
  routes: <RouteBase>[
    GoRoute(
      ...
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, SplashView()),
    ),
    GoRoute(
      path: '/signIn',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, SignInView()),
    ),
    GoRoute(
      path: '/signUp',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, SignUpView()),
    ),

    GoRoute(
      path: '/home',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, HomeView()),
    ),

    GoRoute(
      path: '/cart',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, CartView()),
    ),
    GoRoute(
      path: '/booking',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, BookingView()),
    ),
    GoRoute(
      path: '/orderHistory',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, OrderHistoryScreen()),
    ),
    GoRoute(
      path: '/orderDetails',
    ...
    GoRoute(
      path: '/bookingHistory',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, BookingHistoryView()),
    ),
    GoRoute(
      path: '/services',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, const ServiceView()),
    ),
    GoRoute(
      path: '/selected',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, const SelectedServicesList()),
    ),
    GoRoute(
      path: '/search',
      pageBuilder: (context, state) =>
          buildPageWithTransition(state, SearchView()),
    ),
  ],
);
