        ...
        builder: (context, state) {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "${'orderID'.getString(context)}: ${order.orderID}",
                ...
                Text(
                  "${'status'.getString(context)}: ${order.status}",
                  style: AppTextStyles.body(
                    isDark ? AppColors.darkText : AppColors.lightText,
                  ),
                ),
                const SizedBox(height: 8),
                Text(
                  "${'totalPrice'.getString(context)}: ${order.totalPrice} ${'EGP'.getString(context)}",
                  style: AppTextStyles.body(
                    isDark ? AppColors.darkText : AppColors.lightText,
                  ),
                ),
                ...
                Text(
                  '${'paymentMethod'.getString(context)} : ${order.paymentMethod.getString(context)}',
                  style: AppTextStyles.body(
                    isDark
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            "${'quantity'.getString(context)}: ${item.quantity}",
                            style: TextStyle(
                              color: isDark
                                  ? AppColors.darkText
                                  : AppColors.lightText,
                          ...
                          trailing: Text(
                            "${item.product.productPrice} ${'EGP'.getString(context)}",
                            style: AppTextStyles.body(
                              isDark ? AppColors.darkText : AppColors.lightText,
                            ),
                          ),
